...
#xplace_label::citydots[type='city'][zoom>=4][zoom<=7][localrank<=3] {
...
#xplace_label[zoom>=8][localrank<=3] {
  text-name: @name;
  text-face-name: @sans;
  text-wrap-width: 120;
  text-wrap-before: true;
...
#xroad_label[reflen>=1][reflen<=6]::shield {
